    ...
    <div className="arh-container">
      <div style={{ marginBottom: '24px' }}>
        ...
        <p style={{ color: 'var(--ch-color-text-muted)' }}>
          Semester 5 • Academic Year 2023-24 • Computer Science & Engineering
        </p>
      </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr', gap: '24px', marginBottom: '32px' }}>
        ...
        >
          ...
          >
            ...
            <div>
              <strong>Total Downloads:</strong> {downloadCount}
            </div>
            <div>
              <strong>Quality Score:</strong> ⭐ 4.8 / 5.0
            </div>
            <div>
              <strong>Uploaded By:</strong> Verified Student
            </div>
          </div>
