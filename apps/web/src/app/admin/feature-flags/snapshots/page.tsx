    ...
    <div className="ff-container">
      ...
      <div className="ff-card-panel">
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
          <div style={{ padding: '16px', background: '#0F172A', borderRadius: '8px', border: '1px solid #334155', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            <div>
              <div style={{ fontFamily: 'monospace', fontWeight: 700, color: '#6366F1' }}>snap_1722714488</div>
              <div style={{ fontSize: '12px', color: '#94A3B8', marginTop: '2px' }}>Created 2026-08-03 19:50:00 | HMAC: <code>hmac_sha256_88a91c</code></div>
            </div>
            <button className="ff-btn-primary" onClick={() => alert('Snapshot restored.')}>Restore Snapshot</button>
          </div>
        </div>
      </div>
    </div>
