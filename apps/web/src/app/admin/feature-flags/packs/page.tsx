    ...
    <div className="ff-container">
      ...
      <div className="ff-card-panel">
        ...
        <div style={{ background: '#0F172A', padding: '20px', borderRadius: '8px', border: '1px solid #334155' }}>
          ...
          <p style={{ fontSize: '12px', color: '#94A3B8', marginTop: '4px' }}>Member flags: <code>marketplace.p2p_chat</code>, <code>marketplace.payment</code></p>
          <button className="ff-btn-primary" style={{ marginTop: '14px' }} onClick={() => alert('Feature pack deployed.')}>Deploy Feature Pack</button>
        </div>
      </div>
    </div>
  );
