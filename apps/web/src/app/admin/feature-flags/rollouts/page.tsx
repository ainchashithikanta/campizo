    ...
    <div className="ff-container">
      ...
      <div className="ff-card-panel">
        ...
        <p style={{ color: '#94A3B8', fontSize: '13px', marginBottom: '20px' }}>
          Step-by-step rollout wizard: Feature ➔ Audience ➔ Colleges ➔ Roles ➔ Users ➔ Percentage ➔ Schedule ➔ Impact
          Preview ➔ Approval.
        </p>
        ...
        {step >= 2 && (
          <div>
            ...
            <p style={{ color: '#94A3B8', fontSize: '13px', marginTop: '8px' }}>
              Configuring percentage step rollout for target audience.
            </p>
            <div style={{ display: 'flex', gap: '12px', marginTop: '16px' }}>
              <button className="ff-btn-primary" onClick={() => setStep((s) => Math.max(1, s - 1))}>
                Back
              </button>
              <button className="ff-btn-primary" onClick={() => setStep((s) => Math.min(5, s + 1))}>
                Next Step ➔
              </button>
            </div>
          </div>
