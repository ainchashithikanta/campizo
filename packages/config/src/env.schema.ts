...
export const envSchema = z.object({
  ...
  JWT_SECRET: z.string().min(32).default('production-default-jwt-secret-key-32-chars-minimum!'),
  JWT_EXPIRES_IN: z.string().default('15m'),
  REFRESH_TOKEN_EXPIRES_IN: z.string().default('7d'),
  ENCRYPTION_KEY_32_BYTES: z.string().length(32).default('0123456789abcdef0123456789abcdef'),
