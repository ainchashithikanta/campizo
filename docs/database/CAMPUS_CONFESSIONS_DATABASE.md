...
- **Attributes**:
  ...
  - `created_at`: TIMESTAMPTZ NOT NULL DEFAULT NOW()
- *Strict Security Boundary*: Accessed **strictly via `AnonymousIdentityService`**. No moderation, reporting, analytics, or search queries can access this table directly.
