...
export function registerCollectionRoutes(app: FastifyInstance, deps: CollectionControllerDependencies): void {
  ...
  app.get('/api/v1/collections/:collectionId', async (request: FastifyRequest<{ Params: { collectionId: string } }>, reply: FastifyReply) => {
  ...
  app.put('/api/v1/collections/:collectionId', async (request: FastifyRequest<{ Params: { collectionId: string } }>, reply: FastifyReply) => {
    const collegeId = (request.headers['x-college-id'] as string) || 'default-college';
  ...
  app.delete('/api/v1/collections/:collectionId', async (request: FastifyRequest<{ Params: { collectionId: string } }>, reply: FastifyReply) => {
    return reply.send({
      success: true,
  ...
  app.post('/api/v1/collections/:collectionId/resources', async (request: FastifyRequest<{ Params: { collectionId: string } }>, reply: FastifyReply) => {
    const collegeId = (request.headers['x-college-id'] as string) || 'default-college';
  ...
  app.put('/api/v1/collections/:collectionId/reorder', async (request: FastifyRequest<{ Params: { collectionId: string } }>, reply: FastifyReply) => {
